 ...
 */
public class PlaylistResultActivity extends Activity implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, SeekBar.OnSeekBarChangeListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songlist = Utilities.getSongListForPlaylist(this, album_id);
        ...
        songAdt = new SongAdapter(this, playlistSongs);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        mPlayer.setSong(mPlayer.getSongArrayPos(playlistSongs.get(Integer.parseInt(view.getTag().toString())).getID()));
        mPlayer.playSong();
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnBackward) {
            ...
            if (currentSongIndex > 0) {
                mPlayer.setSong(mPlayer.getSongArrayPos(playlistSongs.get(currentSongIndex - 1).getID()));
                mPlayer.playSong();
                currentSongIndex = currentSongIndex - 1;
            } else {
                mPlayer.setSong(mPlayer.getSongArrayPos(playlistSongs.get(playlistSongs.size() - 1).getID()));
                mPlayer.playSong();
        ...
        if (v.getId() == R.id.btnForward) {
            ...
            if (currentSongIndex < (playlistSongs.size() - 1)) {
                ...
                mPlayer.setSong(mPlayer.getSongArrayPos(playlistSongs.get(0).getID()));
                mPlayer.playSong();
                currentSongIndex = 0;
            }
        }
    ...
    {
        imageView.setImageBitmap(playlistSongs.get(mPlayer.getCurrentSongIndex()).getImage());
        sTitle.setText("" + playlistSongs.get(mPlayer.getCurrentSongIndex()).getTitle());
    }
