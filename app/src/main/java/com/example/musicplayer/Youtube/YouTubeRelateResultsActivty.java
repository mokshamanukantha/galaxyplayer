 ...
 */
public class YouTubeRelateResultsActivty extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void getData()
    {
        String link = "http://gdata.youtube.com/feeds/api/standardfeeds/most_popular?v=2&alt=jsonc";
        HttpClient httpclient = new DefaultHttpClient();
        httpclient.getParams().setParameter(CoreProtocolPNames.PROTOCOL_VERSION, HttpVersion.HTTP_1_1);
        if(ID!=null)
        {
            link = "https://gdata.youtube.com/feeds/api/videos/"+ ID +"/related?v=2&alt=jsonc";
        }
    ...
    class TheTask extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void result) {
            ...
            pd.dismiss();
            YouTubeVideoAdapter you = new YouTubeVideoAdapter(YouTubeRelateResultsActivty.this,msg,title,thumb,views,category,duration,id);
