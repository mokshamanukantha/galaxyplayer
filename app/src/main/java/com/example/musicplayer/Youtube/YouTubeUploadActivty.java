 ...
 */
public class YouTubeUploadActivty extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void getData() {
        ...
        if (TOKEN != null) {
            link = "https://gdata.youtube.com/feeds/api/users/default/uploads?access_token=" + TOKEN + "&v=2&alt=jsonc";
        }
    ...
    class TheTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            pd.dismiss();
            YouTubeVideoAdapter you = new YouTubeVideoAdapter(YouTubeUploadActivty.this, msg, title, thumb, views, category, duration, id);
