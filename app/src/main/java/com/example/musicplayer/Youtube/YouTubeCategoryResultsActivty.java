 ...
 */
public class YouTubeCategoryResultsActivty extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void getData()
    {
        ...
        if(Category!=null)
        {
            link = "https://gdata.youtube.com/feeds/api/standardfeeds/most_popular_"+Category+"?v=2&alt=jsonc";
        }
    ...
    class TheTask extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void result) {
            ...
            pd.dismiss();
            YouTubeVideoAdapter you = new YouTubeVideoAdapter(YouTubeCategoryResultsActivty.this,msg,title,thumb,views,category,duration,id);
