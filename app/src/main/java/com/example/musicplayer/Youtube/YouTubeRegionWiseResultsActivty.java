 ...
 */
public class YouTubeRegionWiseResultsActivty extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void getData()
    {
        String link = "http://gdata.youtube.com/feeds/api/standardfeeds/US/most_popular?v=2&alt=jsonc";
        HttpClient httpclient = new DefaultHttpClient();
        httpclient.getParams().setParameter(CoreProtocolPNames.PROTOCOL_VERSION, HttpVersion.HTTP_1_1);
        if(Category!=null)
        {
            link = "http://gdata.youtube.com/feeds/api/standardfeeds/"+Category+"/most_popular?v=2&alt=jsonc";
        }
        ...
        try
        {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String views1 = jsonObject.getString("viewCount");
    ...
    class TheTask extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void result) {
            ...
            pd.dismiss();
            YouTubeVideoAdapter you = new YouTubeVideoAdapter(YouTubeRegionWiseResultsActivty.this,msg,title,thumb,views,category,duration,id);
