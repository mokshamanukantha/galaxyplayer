 ...
 */
public class YouTubeRelatedActivty extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(this,YouTubeRelateResultsActivty.class);
    ...
    class TheTask extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void result) {
            ...
            pd.dismiss();
            YouTubeVideoAdapter you = new YouTubeVideoAdapter(YouTubeRelatedActivty.this,msg,title,thumb,views,category,duration,id);
